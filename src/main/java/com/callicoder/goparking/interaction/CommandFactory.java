...
public class CommandFactory {
    ...
    public static CommandFactory init(ParkingLotCommandHandler parkingLotCommandHandler) {
        ...
        cf.addCommand("registration_numbers_for_cars_with_colour", new RegistrationNumberCarColorCommand(parkingLotCommandHandler));
        cf.addCommand("slot_numbers_for_cars_with_colour", new SlotNumberForCarColorCommand(parkingLotCommandHandler));
        cf.addCommand("slot_number_for_registration_number", new SlotNumberForRegistrationCommand(parkingLotCommandHandler));
